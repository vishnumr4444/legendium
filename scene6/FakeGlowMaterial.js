/**
 * About: `scene6/FakeGlowMaterial.js`
 *
 * Custom Three.js `ShaderMaterial` used in Scene 6 to create a fake glow / hologram highlight.
 * Typically applied to interactive parts (pins/connectors/components) to guide the user.
 */
...
/**
 * Custom shader material that fakes a glowing, hologram-like effect.
 * Used to highlight components (pins, connectors, etc.) in Scene 6.
 */
